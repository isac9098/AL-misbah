export default function OnlineTrainingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* المحتوى الرئيسي */}
      <div 
        className="flex-1 bg-cover bg-center flex items-center justify-center py-16"
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=2000&q=80')",
        }}
      >
        <div className="bg-white/80 backdrop-blur-md p-10 rounded-2xl max-w-4xl text-center shadow-2xl mx-4">
